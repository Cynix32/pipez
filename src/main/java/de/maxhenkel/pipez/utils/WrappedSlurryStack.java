...
public class WrappedSlurryStack extends AbstractStack<SlurryStack> {

    public WrappedSlurryStack(SlurryStack stack) {
        super(stack);
    }
    ...
    public List<ITextComponent> getTooltip(Screen screen) {
        ...
        if (Minecraft.getInstance().options.advancedItemTooltips) {
            ResourceLocation registryName = MekanismAPI.slurryRegistry().getKey(stack.getType());
